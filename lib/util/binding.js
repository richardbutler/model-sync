(function() {
    ...
    var Binding = {
        ...
        createObject: function( attributes ) {
            ...
            for ( key in attributes ) {
                if ( attributes.hasOwnProperty( key ) ) {
                    ...
                    this.createBindableProperty( o, key );
                    
                    if ( typeof value === "object" &&
                      !( value instanceof Array ) &&
                         value.hasOwnProperty !== undefined ) {
                        attributes[ key ] = this.createObject( value );
                    }
                }
            }
        ...
        /**
         * Creates a bindable property on an object.
         * 
         * @param {Object} o
         * @param {String} key
         * @param {Object} [initialValue]
         */
        createBindableProperty: function( o, key, initialValue ) {
